...
use Leo108\CorpWeChat\Response\Service\LoginInfoResponse;
use Leo108\CorpWeChat\Response\Service\LoginUrlResponse;
...
class Service extends AbstractApi
{
    ...
    {
        return new LoginInfoResponse($this->httpPostJson('service/get_login_info', ['auth_code' => $authCode]));
    }
    ...
    public function getLoginUrl($loginTicket, $target, $agentId = null)
    {
        ...
        return new  LoginUrlResponse($this->httpPostJson('service/get_login_url', $param));
    }
}
